...
const Cart = ({ history }) => {
    ...
    return (
        <Fragment>
            ...
            {cartItems.length === 0 ? <h3 className="mt-5">Giỏ hàng trống</h3> : (
                <Fragment>
                    ...
                    <div className="row d-flex justify-content-between">
                                    ...
                                    <div className="cart-item" key={item.product}>
                                        <div className="row">
                                            ...
                                            <div className="col-4 col-lg-2 mt-4 mt-lg-0">
                                                <p className='text-primary'>{item.price} VNĐ</p>
                                            </div>
                        ...
                        <div className="col-12 col-lg-4 my-4">
                            <div id="order_summary">
                                ...
                                <p>Tổng tiền: <span className="order-summary-values">{cartItems.reduce((acc, item) => acc + item.quantity * item.price, 0)} VNĐ</span></p>
