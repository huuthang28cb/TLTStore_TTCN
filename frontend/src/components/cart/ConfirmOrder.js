            ...
            <div className="row d-flex justify-content-between">
                            ...
                            <div className="cart-item my-1" key={item.product}>
                                <div className="row">
                                    ...
                                    <div className="col-4 col-lg-4 mt-4 mt-lg-0">
                                        <p>{item.quantity} x {item.price} VNĐ = <b>{(item.quantity * item.price).toFixed(2)} VNĐ</b></p>
                                    </div>
                ...
                <div className="col-12 col-lg-3 my-4">
                    <div id="order_summary">
                        ...
                        <hr />
                        <p>Thành tiền:  <span className="order-summary-values">{itemsPrice} VNĐ</span></p>
                        <p>Phí vận chuyển: <span className="order-summary-values">{shippingPrice} VNĐ</span></p>
                        <p>Thuế:  <span className="order-summary-values">{taxPrice} VNĐ</span></p>
