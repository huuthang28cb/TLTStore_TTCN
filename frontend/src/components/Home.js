        ...
        <Fragment>
            ...
            {loading ? <Loader /> : (
                <Fragment>
                    ...
                    <h1 id="products_heading" className="container container-fluid">Sản phẩm mới cập nhật</h1>
                    ...
                    <h1 id="products_heading" className="container container-fluid">Sản phẩm bán chạy</h1>
