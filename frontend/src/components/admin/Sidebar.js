                ...
                <ul className="list-unstyled components">
                    ...
                    <li>
                        ...
                        <ul className="collapse list-unstyled" id="productSubmenu">
                            <li>
                                <Link to="/admin/products"><i className="fa fa-clipboard"></i> Cập nhật thông tin sản phẩm</Link>
                            </li>

                            <li>
                                <Link to="/admin/product"><i className="fa fa-plus"></i> Thêm sản phẩm</Link>
                            </li>
                        </ul>
                    </li>
